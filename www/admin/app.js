 ...
 *
 */
angular.module('altrs.controller', [
  'altrs.controller.main',
  'altrs.controller.login',
  'altrs.controller.info',
  'altrs.controller.query'
]);

angular.module('altrs.service', [
  'altrs.service.api',
  'altrs.service.user',
  'altrs.service.channel',
  'altrs.service.socket'
]);

angular.module('altrs.app',[
   'ui.router',
   'ui.bootstrap',
   'ui.materialize',
   'ui.router.title',
   ...
   'altrs.directive.form',
   'altrs.directive.certificate',
   'altrs.directive.blockchain'
])
